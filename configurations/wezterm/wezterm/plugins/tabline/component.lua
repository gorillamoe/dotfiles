local config = require("plugins.tabline.config")
local extension = require("plugins.tabline.extension")
local mode = require("plugins.tabline.components.window.mode")
local util = require("plugins.tabline.util")
---@type Wezterm
