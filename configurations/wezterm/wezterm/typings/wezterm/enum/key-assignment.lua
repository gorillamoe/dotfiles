...
---@alias wezterm.CopyTo "Clipboard"|"ClipboardAndPrimarySelection"|"PrimarySelection"
---@alias wezterm.CopyMode
---|"AcceptPattern"
---|"ClearPattern"
---|"ClearSelectionMode"
---|"Close"
...
---@alias wezterm.SendKey wezterm.Key
...
---
---@field mods? string
---@field action? wezterm.KeyAssignment|wezterm.Action

---@class wezterm.ActionClass
...
---@alias wezterm.KeyAssignFunction fun(param: any): wezterm.Action

---Can also be called as function like older versions of wezterm did.
---
---@class wezterm.ActionFuncClass
---@field ActivateCommandPalette wezterm.KeyAssignFunction
---@field ActivateCopyMode wezterm.KeyAssignFunction
...
---@return wezterm.Action select_text_at_mouse_cursor
function ActionFunc.SelectTextAtMouseCursor(s) end

---@param s string
---@return wezterm.Action send_string
function ActionFunc.SendString(s) end

---@param param wezterm.SendKey
---@return wezterm.Action send_key
function ActionFunc.SendKey(param) end

---@param act wezterm.CopyMode
---@return wezterm.Action copy_mode
function ActionFunc.CopyMode(act) end

---@param destination wezterm.CopyTo
---@return wezterm.Action copy_to
...
---This is useful when you want a single key press to trigger multiple actions.
---
---@param action wezterm.ActionClass[]
...
---This is useful when you want a single key press to trigger multiple actions.
---
---@param action wezterm.ActionFuncClass[]
function ActionFunc.Multiple(action) end
...
---@alias wezterm.Action wezterm.ActionFuncClass|wezterm.ActionClass
