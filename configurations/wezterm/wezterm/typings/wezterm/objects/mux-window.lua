...
---@class wezterm.MuxWindow.TabInfo
...
---A `MuxTab` object.
---
---@field tab wezterm.MuxTab

---@class wezterm.SpawnTab
...
---
---@param self wezterm.MuxWindow
---@param args? wezterm.SpawnTab
---@return wezterm.MuxTab tab
---@return wezterm.Pane pane
---@return wezterm.MuxWindow window
...
---
---@param self wezterm.MuxWindow
---@return wezterm.MuxWindow.TabInfo[] tabs
