...
---@class wezterm.SpawnSplit: wezterm.SpawnTab
---@field direction? "Right"|"Left"|"Top"|"Bottom"
---@field top_level? boolean
---@field size? number

---@class wezterm.PaneMetadata
...
---@class wezterm.RenderableDimensions
...
---
---@param self wezterm.Pane
---@return wezterm.Url|nil cwd
function M:get_current_working_dir() end

---Returns a Lua representation of the `wezterm.StableCursorPosition` struct
---that identifies the cursor's position, visibility and shape.
---
---@param self wezterm.Pane
---@return wezterm.StableCursorPosition position
...
---
---@param self wezterm.Pane
---@return wezterm.RenderableDimensions dimensions
...
---
---@param self wezterm.Pane
---@return wezterm.PaneMetadata|nil metadata
