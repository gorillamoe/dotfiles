...
---@alias wezterm.LocalProcessStatus "Idle"|"Run"|"Sleep"|"Stop"|"Zombie"|"Tracing"|"Dead"|"Wakekill"|"Waking"|"Parked"|"LockBlocked"|"Unknown"

---Represents a process running on the local machine.
---
---@class wezterm.LocalProcessInfo
...
---
---@field children wezterm.LocalProcessInfo[]
...
--- - `"Unknown"`
---
---@field status wezterm.LocalProcessStatus
