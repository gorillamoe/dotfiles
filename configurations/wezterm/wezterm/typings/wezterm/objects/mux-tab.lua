...
---
---@param self wezterm.MuxTab
---@return wezterm.Pane active_pane
...
---@return wezterm.Pane adjacent_pane
...
---
---@param self wezterm.MuxTab
---@return wezterm.PaneInformation[] info_panes
