...
---Global type alias to avoid conflicts with variable names
---@alias WeztermConfig wezterm.Config

---Global type declaration for require("wezterm")
---@global wezterm Wezterm
...
---@class wezterm.FormatItemSpec
---@field Attribute? wezterm.FormatItemAttribute
---@field Foreground? wezterm.ColorSpec
---@field Background? wezterm.ColorSpec
---@field Text? string

---@alias wezterm.FormatItem "ResetAttributes"|wezterm.FormatItemSpec

---This is a virtual modifier used by wezterm
---@alias wezterm.Modifiers
---|"ALT"
---|"CTRL"
---|"ENHANCED_KEY"
---|"LEADER"
...
---
---@alias wezterm.WindowDecorations
---|"NONE"
---|"TITLE"
---|"RESIZE"
...
---@alias wezterm.PaletteAnsi "black"|"maroon"|"green"|"olive"|"navy"|"purple"|"teal"|"silver"
---@alias wezterm.PaletteBrights "grey"|"red"|"lime"|"yellow"|"blue"|"fuchsia"|"aqua"|"white"
---@alias wezterm.AnsiColor "Black"|"Maroon"|"Green"|"Olive"|"Navy"|"Purple"|"Teal"|"Silver"|"Grey"|"Red"|"Lime"|"Yellow"|"Blue"|"Fuchsia"|"Aqua"|"White"
...
---
---@class wezterm.TabBar: wezterm.TabBarColors
...
---
---@field active_tab? wezterm.TabBarColor
---Inactive tabs are the tabs that do not have focus.
---
---@field inactive_tab? wezterm.TabBarColor
---You can configure some alternate styling when
---the mouse pointer moves over inactive tabs.
---
---@field inactive_tab_hover? wezterm.TabBarColor
---The new tab button that let you create new tabs.
---
---@field new_tab? wezterm.TabBarColor
---You can configure some alternate styling
---when the mouse pointer moves over the new tab button.
---
---@field new_tab_hover? wezterm.TabBarColor

---@class wezterm.Palette
---A list of 8 colors corresponding to the basic ANSI palette.
---
---@field ansi? table<integer, wezterm.PaletteAnsi>
...
---
---@field brights? table<integer, wezterm.PaletteBrights>
...
---
---@field copy_mode_active_highlight_bg? wezterm.ColorSpec
...
--- - `"White"`
---
---@field copy_mode_active_highlight_fg? wezterm.ColorSpec
---Colors for `copy_mode` and `quick_select`.
---
---In `copy_mode`, the color of the active text is:
---
...
--- 2. `selection` otherwise
---
---@field copy_mode_inactive_highlight_bg? wezterm.ColorSpec
---Use [`AnsiColor`](lua://AnsiColor)
---to specify one of the ANSI color palette values
---(index 0-15), using one of the following values:
---
...
--- - `"White"`
---
---@field copy_mode_inactive_highlight_fg? wezterm.ColorSpec
...
---@field input_selector_label_bg? wezterm.ColorSpec
---@field input_selector_label_fg? wezterm.ColorSpec
---@field launcher_label_bg? wezterm.ColorSpec
---@field launcher_label_fg? wezterm.ColorSpec
---@field quick_select_label_bg? wezterm.ColorSpec
---@field quick_select_label_fg? wezterm.ColorSpec
---@field quick_select_match_bg? wezterm.ColorSpec
---@field quick_select_match_fg? wezterm.ColorSpec
...
---@alias wezterm.FreeTypeLoadFlags
---|"DEFAUlT"
---|"NO_HINTING"
---|"NO_BITMAP"
---|"FORCE_AUTOHINT"
...
---@alias wezterm.HarfbuzzFeatures
---|"calt=0"
---|"clig=0"
---|"liga=0"
---|"calt=1"
...
---@class wezterm.FontAttributes
---Whether the font should be a bold variant.
---
---@field weight? wezterm.FontWeight
---@field stretch? wezterm.FontStretch
...
---
---@class wezterm.FontFamilyAttributes: wezterm.FontAttributes
---@field family string
---When [`config.font_shaper`](lua://wezterm.Config.font_shaper) is
...
---
---@field harfbuzz_features? wezterm.HarfbuzzFeatures[]
...
---
---@field freetype_load_flags? wezterm.FreeTypeLoadFlags
---@field assume_emoji_presentation? boolean

---@class wezterm.Fonts
---@field fonts wezterm.FontAttributes[]

---@class wezterm.WindowFrameConfig
...
---@class wezterm.HyperlinkRule
---@field regex string
---@field format string
---@field highlight? 1

---@class wezterm.SerialDomain
...
---@class wezterm.LeaderKey: wezterm.Key
...
---@class wezterm.AugmentCommandPaletteReturn
...
---
---@field action wezterm.KeyAssignment
...
---@class wezterm.StableCursorPosition
...
---@class wezterm.LinearGradientOrientation
---@field angle number

---@class wezterm.RadialGradientOrientation
---@field radius? number
---@field cx? number
---@field cy? number

---@alias wezterm.GradientOrientation
---|"Horizontal"
---|"Vertical"
---|{ Linear: wezterm.LinearGradientOrientation }
---|{ Radial: wezterm.RadialGradientOrientation }

---@class wezterm.Gradient
---@field colors string[]
---@field orientation? wezterm.GradientOrientation
...
---@class wezterm.ColorSchemeMetaData
---@field name? string
---@field author? string
...
---@alias wezterm.ActionCallback fun(win: wezterm.Window, pane: wezterm.Pane, ...: any): false|wezterm.Action|nil

---@alias wezterm.CursorStyle
---|"BlinkingBar"
---|"BlinkingBlock"
---|"BlinkingUnderline"
---|"SteadyBar"
...
---@class wezterm.ScreenInformation
---@field name string
---@field x number
---@field y number
---@field height number
...
---@class wezterm.GuiScreensInfo
---@field main wezterm.ScreenInformation
---@field active wezterm.ScreenInformation
---@field byName { [string]: wezterm.ScreenInformation }
---@field origin_x number
---@field origin_y number
---@field virtual_height number
---@field virtual_width number

---@class wezterm.KeyBinding
---@field key string
---@field action wezterm.Action
---@field mods? string

---@class wezterm.MouseEventInfo
---@field streak number
---@field button "Left"|"Right"|"Middle"|{ WheelDown: number }|{ WheelUp: number }

---@class wezterm.MouseDownEvent
---@field Down wezterm.MouseEventInfo

---@class wezterm.MouseUpEvent
---@field Up wezterm.MouseEventInfo

---@class wezterm.MouseDragEvent
---@field Drag wezterm.MouseEventInfo

---@alias wezterm.MouseEvent wezterm.MouseDownEvent|wezterm.MouseDragEvent|wezterm.MouseUpEvent

---@class wezterm.MouseBindingBase
---@field event wezterm.MouseEvent
---@field action wezterm.Action
---@field mouse_reporting? boolean
---@field alt_screen? boolean|"Any"

---@class wezterm.MouseBinding: wezterm.MouseBindingBase
---@field mods string
...
---
---@alias wezterm.CallbackWindowPane fun(window: wezterm.Window, pane: wezterm.Pane)

---@alias wezterm.AugmentCallbackWindowPane fun(window: wezterm.Window, pane: wezterm.Pane): wezterm.AugmentCommandPaletteReturn
...
---Returns a [`wezterm.Config`](lua://wezterm.Config) object that can be used to define your configuration.
---@field config_builder fun(): wezterm.Config
---Helper for defining key assignment actions in your configuration file.
---@field action wezterm.Action
---Helper function for defining action callbacks.
---@field action_callback fun(callback: wezterm.ActionCallback): wezterm.Action
---Adds path to the list of files that are watched for config changes.
---@field add_to_config_reload_watch_list fun(path: string): nil
---Accepts an argument list; it will attempt to spawn that command in the background.
---@field background_child_process fun(args: string[]): nil
---Returns the battery information for each of the installed batteries on the system.
---@field battery_info fun(): wezterm.BatteryInfo[]
---Given a string parameter, returns the number of columns that text occupies in the terminal.
---@field column_width fun(value: string): number
---Returns the compiled-in default hyperlink rules as a table.
---@field default_hyperlink_rules fun(): wezterm.HyperLinkRule[]
---Computes a list of SshDomain objects based on the set of hosts discovered in ~/.ssh/config.
---@field default_ssh_domains fun(): wezterm.SshDomain[]
---Computes a list of WslDomain objects, each one representing an installed WSL distribution.
---@field default_wsl_domains fun(): wezterm.WslDomain[]
---Resolves the registered callback(s) for the specified event name and calls each of them in turn.
---@field emit fun(event: string, ...: any): boolean
---This function will parse your ssh configuration file(s) and extract host names.
---@field enumerate_ssh_hosts fun(ssh_config_file_name: string[]|string|nil): table<string, wezterm.SshHost>
---Constructs a font specification. Can be called with (name, attributes) or (attributes).
---@field font fun(name: string, attributes?: wezterm.FontAttributes): wezterm.Fonts|wezterm.FontFamilyAttributes
---@field font fun(attributes: wezterm.FontFamilyAttributes): wezterm.Fonts|wezterm.FontFamilyAttributes
---Creates a font specification with fallback fonts.
---@field font_with_fallback fun(fonts: (string|wezterm.FontAttributes)[]): wezterm.Fonts
---Can be used to produce a formatted string with terminal graphic attributes.
---@field format fun(...: wezterm.FormatItem[]): string
---Returns a Lua table keyed by color scheme name of the builtin color schemes.
---@field get_builtin_color_schemes fun(): table<string, wezterm.Palette>
---This function evaluates the glob pattern and returns an array containing the absolute file names.
---@field glob fun(pattern: string, relative_to: string|nil): string[]
---Given a gradient spec and a number of colors, returns a table holding that many colors.
---@field gradient_colors fun(gradient: wezterm.Gradient, num_colors: number): wezterm.Color[]
...
---Parses a JSON string and returns the corresponding Lua values.
---@field json_parse fun(value: string): any
---Logs the provided message string through wezterm's logging layer at ERROR level.
---@field log_error fun(msg: string, ...: any): nil
---Logs the provided message string through wezterm's logging layer at INFO level.
---@field log_info fun(msg: string, ...: any): nil
---Logs the provided message string through wezterm's logging layer at WARN level.
---@field log_warn fun(msg: string, ...: any): nil
---Registers an event handler. Can be called with various event types and callback signatures.
---@field on fun(event: string, callback: fun(...: any)): ...
---This function opens the specified path_or_url with the specified application or default application.
---@field open_with fun(path_or_url: string, application: string|nil): nil
---Returns a copy of a string that is at least min_width columns, padding spaces to the left.
---@field pad_left fun(s: string, min_width: integer): string
---Returns a copy of a string that is at least min_width columns, padding spaces to the right.
---@field pad_right fun(s: string, min_width: integer): string
---This function is intended to help with generating KeyBinding or MouseBinding entries for any combination of modifiers.
---@field permute_any_mods fun(T: table): wezterm.KeyBinding[]|wezterm.MouseBinding[]
---This function is intended to help with generating KeyBinding or MouseBinding entries, including NONE modifier.
---@field permute_any_or_no_mods fun(T: table): wezterm.KeyBinding[]|wezterm.MouseBinding[]
---Reads the directory at the specified path and returns an array of file names.
---@field read_dir fun(path: string): string[]
---Immediately causes the configuration to be reloaded and re-applied.
---@field reload_configuration fun(): nil
...
---This function returns a boolean indicating whether WezTerm runs in a WSL container.
---@field running_under_wsl fun(): boolean
---Joins together its array arguments by applying POSIX-style shell quoting.
---@field shell_join_args fun(args: string[]): string
---Quotes its single argument using POSIX shell quoting rules.
---@field shell_quote_arg fun(s: string): string
---Splits a command line into a string argument array in accordance with POSIX shell rules.
---@field shell_split fun(line: string): string[]
---Suspends the execution of the script for the specified number of milliseconds.
---@field sleep_ms fun(ms: integer): nil
---Takes the input string and splits it by newlines, returning an array of strings.
---@field split_by_newlines fun(s: string): string[]
---Formats the current local date/time into a string using Rust chrono strftime syntax.
---@field strftime fun(format: string): string
---Formats the current UTC date/time into a string using Rust chrono strftime syntax.
---@field strftime_utc fun(format: string): string
---Returns a copy of a string that is no longer than max_width columns, truncating from the left.
---@field truncate_left fun(s: string, max_width: integer): string
---Returns a copy of a string that is no longer than max_width columns, truncating from the right.
---@field truncate_right fun(s: string, max_width: integer): string
---Takes as input a string and attempts to convert it from utf16 to utf8.
---@field utf16_to_utf8 fun(s: string): string
---@type Wezterm
local Wezterm = {}
...
---Returns a [`wezterm.Config`](lua://wezterm.Config)
---object that can be used to define your configuration.
---
---See the [`wezterm.Config`](lua://wezterm.Config)
---type for more info.
---
...
---[`config.wsl_domains`](lua://wezterm.Config.wsl_domains)
...
---
---@param name string
---@param attributes wezterm.FontAttributes|nil
---@return wezterm.Fonts|wezterm.FontFamilyAttributes
...
---   for emoji
---
---@param attributes wezterm.FontFamilyAttributes
---@return wezterm.Fonts|wezterm.FontFamilyAttributes
...
---function.
---
---@param fonts (string|wezterm.FontAttributes)[]
---@return wezterm.Fonts
...
---
---@return table<string, wezterm.Palette>
---@deprecated
...
---@param callback wezterm.AugmentCallbackWindowPane
...
---
---@param event "bell"
---@param callback wezterm.CallbackWindowPane
function Wezterm.on(event, callback) end
...
---@param callback fun(tab: wezterm.TabInformation, tabs: wezterm.TabInformation[], panes: wezterm.PaneInformation[], config: wezterm.Config, hover: boolean, max_width: number): string|wezterm.FormatItem
function Wezterm.on(event, callback) end
...
---@param callback fun(window: wezterm.Window, pane: wezterm.Pane, tabs: wezterm.MuxTab[], panes: wezterm.Pane[], config: wezterm.Config): string
function Wezterm.on(event, callback) end
...
---@param callback fun(domain: wezterm.MuxDomain|wezterm.ExecDomain)
function Wezterm.on(event, callback) end
...
---@param callback fun(cmd?: wezterm.SpawnCommand)
function Wezterm.on(event, callback) end
...
---[`skip_close_confirmation_for_processes_named`](lua://wezterm.Config.skip_close_confirmation_for_processes_named)
---
---@param event "mux-is-process-stateful"
---@param callback fun(info: wezterm.LocalProcessInfo): boolean
function Wezterm.on(event, callback) end
...
---@param callback fun(window: wezterm.Window, pane: wezterm.Pane, button: "Left"|"Middle"|"Right", default_action: wezterm.KeyAssignment)
function Wezterm.on(event, callback) end
...
---@param callback fun(window: wezterm.Window, pane: wezterm.Pane, uri: string): boolean|nil
function Wezterm.on(event, callback) end
...
---[`config.status_update_interval_milliseconds`](lua://wezterm.Config.status_update_interval)
...
---[`config.status_update_interval`](lua://wezterm.Config.status_update_interval)).
---
...
---@param callback fun(window: wezterm.Window, pane: wezterm.Pane, name: string, value: string)
function Wezterm.on(event, callback) end
...
---(when [`config.automatically_reload_config`](lua://wezterm.Config.automatically_reload_config)
...
---Adds path to the list of files that are watched for config changes.
---
---If [`config.automatically_reload_config`](lua://wezterm.Config.automatically_reload_config)
