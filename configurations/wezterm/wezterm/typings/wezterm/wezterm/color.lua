...
---@class wezterm.ImageExtractorParams
...
--- - [`ImageExtractorParams`](lua://wezterm.ImageExtractorParams)
---
--- ---
...
---@param params? wezterm.ImageExtractorParams
---@return string[]
function C.extract_colors_from_image(filename, params) end

---Constructs a new
---[`Color`](lua://wezterm.Color) object
...
---
---@return table<string, wezterm.Palette> schemes
...
---
---`gradient` is any [`Gradient`](lua://wezterm.Gradient)
...
---
---@param gradient wezterm.Gradient
---@param num_colors number
---@return wezterm.Color[] colors
...
---@return wezterm.Palette colors
---@return wezterm.ColorSchemeMetaData metadata
...
---
---See:
--- - [`Palette`](lua://wezterm.Palette)
--- - [`ColorSchemeMetaData`](lua://wezterm.ColorSchemeMetaData)
---
---@param file_name string
---@return wezterm.Palette scheme
---@return wezterm.ColorSchemeMetaData metadata
...
---
---@param colors wezterm.Palette
---@param metadata wezterm.PaneMetadata
---@param file_name string
