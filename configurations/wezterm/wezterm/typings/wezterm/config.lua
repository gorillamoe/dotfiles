...
---@alias wezterm.QuickSelectAlphabet
...
---@alias wezterm.DroppedFileQuoting
---|"None"
---|"Posix"
---|"SpacesOnly"
---|"Windows"
...
---@alias wezterm.DefaultCursorStyle
---|"BlinkingBar"
---|"BlinkingBlock"
---|"BlinkingUnderline"
---|"SteadyBar"
...
---
---@class wezterm.BackgroundLayer
---Defines the source of the layer texture data.
---
---@field source? { File: string, speed: number? }|{ Gradient: wezterm.Gradient, Color: string }
...
---
---@field hsb? wezterm.HsbTransform
...
---@alias wezterm.AllFontAttributes wezterm.Fonts|wezterm.FontAttributes|wezterm.FontFamilyAttributes

---@class wezterm.FontRules
---@field font? wezterm.AllFontAttributes
...
---a table that is interpreted as the internal `wezterm.Config` struct type.
---
---```lua
------@type Wezterm
...
---[`config.tiling_desktop_environments`](lua://wezterm.Config.tiling_desktop_environments).
---
...
---[`config.front_end`](lua://wezterm.Config.front_end) set
...
---[`config.custom_block_glyphs`](lua://wezterm.Config.custom_block_glyphs)
...
---
---See also:
--- - [`config.visual_bell`](lua://wezterm.Config.visual_bell)
...
---
---@field background? wezterm.BackgroundLayer[]
...
---
---@field bypass_mouse_reporting_modifiers? wezterm.Modifiers
...
---[`config.font`](lua://wezterm.Config.font)
---and [`config.font_size`](lua://wezterm.Config.font_size)
...
---
---See also:
--- - [`config.line_height`](lua://wezterm.Config.line_height)
---
...
---
---See also:
--- - [`config.treat_east_asian_ambiguous_width_as_wide`](lua://wezterm.Config.treat_east_asian_ambiguous_width_as_wide)
---
---@field cell_widths? wezterm.CellWidth[]
...
---to specify the font.
---
---@field char_select_font? wezterm.Fonts|wezterm.FontFamilyAttributes
...
--- - [`config.show_update_window`](lua://wezterm.Config.show_update_window)
---
...
---[`config.exit_behavior`](lua://wezterm.Config.exit_behavior)
...
---
---@field color_scheme? wezterm.Colorschemes|string
...
---
---@field color_schemes? table<string, wezterm.Palette>
---Specifies the color palette.
---
---Described in more detail in [Colors & Appearance](https://wezterm.org/config/appearance.html).
---
---@field colors? wezterm.Palette
...
---```
---
---@field command_palette_font? wezterm.AllFontAttributes
...
---[`config.underline_thickness`](lua://wezterm.Config.underline_thickness).
---
...
---
---@field daemon_options? wezterm.DaemonOptions
...
---
---@field default_cursor_style? wezterm.DefaultCursorStyle
...
--- - [`config.default_mux_server_domain`](lua://wezterm.Config.default_mux_server_domain)
---
------
...
--- - [`config.default_domain`](lua://wezterm.Config.default_domain).
---
--- ---
...
---[`config.quick_select_patterns`](lua://wezterm.Config.quick_select_patterns)
...
---
---[`config.allow_win32_input_mode`](lua://wezterm.Config.allow_win32_input_mode)
...
---
---@field exec_domains? wezterm.ExecDomain[]
...
--- - [`config.clean_exit_codes`](lua://wezterm.Config.clean_exit_codes)
---
...
---[`config.font_locator`](lua://wezterm.Config.font_locator),
...
---[`config.font_dirs`](lua://wezterm.Config.font_dirs)
...
---
---@field font_rules? wezterm.FontRules
...
--- - [`HsbTransform`](lua://HsbTransform)
---
---@field foreground_text_hsb? wezterm.HsbTransform
...
--- - [`config.freetype_render_target`](lua://wezterm.Config.freetype_render_target)
--- - [`config.freetype_load_flags`](lua://wezterm.Config.freetype_load_flags)
---
...
---[`config.freetype_load_target`](lua://wezterm.Config.freetype_load_target).
---
...
---
---@field hyperlink_rules? wezterm.HyperlinkRule[]
...
---
---@field inactive_pane_hsb? wezterm.HsbTransform
...
---[`config.window_decorations`](lua://wezterm.Config.window_decorations) has
...
---
---@field integrated_title_button_color? "Auto"|wezterm.PaletteBrights
---Configures the visual style of the tabbar-integrated titlebar button replacements that are shown
---when [`config.window_decorations`](lua://wezterm.Config.window_decorations) has
---a value of `"INTEGRATED_BUTTONS|RESIZE"`.
---
---Possible styles are:
---
...
---Combinined with [`config.window_background_opacity`](lua://wezterm.Config.window_background_opacity),
...
---
---@field launch_menu? wezterm.SpawnCommand[]
...
---
---@field leader? wezterm.LeaderKey
...
---[`config.font_size`](lua://wezterm.Config.font_size).
---
...
---[`config.use_ime`](lua://wezterm.Config.use_ime).
---
...
---
---@field macos_forward_to_ime_modifier_mask? wezterm.Modifiers
...
---[`config.native_macos_fullscreen_mode`](lua://wezterm.Config.native_macos_fullscreen_mode).
---
...
---Combined with [`config.window_background_opacity`](lua://wezterm.Config.window_background_opacity)
...
---
---@field mouse_bindings? wezterm.MouseBindingBase[]
...
---```
---
---@field notification_handling? wezterm.NotifyHandler
...
---```
---
---@field pane_select_font? wezterm.AllFontAttributes
...
---
---@field quick_select_alphabet? wezterm.QuickSelectAlphabet
...
---
---@field quote_dropped_files? wezterm.DroppedFileQuoting
...
---
---@field serial_ports? wezterm.SerialDomain[]
...
---
---The [`config.tab_and_split_indices_are_zero_based`](lua://wezterm.Config.tab_and_split_indices_are_zero_based)
...
---
---@field ssh_domains? wezterm.SshDomain[]
...
---[`config.swallow_mouse_click_on_pane_focus`](lua://wezterm.Config.swallow_mouse_click_on_pane_focus)
...
---If `true`,
---[`config.show_tab_index_in_tab_bar`](lua://wezterm.Config.show_tab_index_in_tab_bar)
...
------
---When setting
---[`config.window_decorations`](lua://wezterm.Config.window_decorations) to
...
---
---@field tab_bar_style? wezterm.TabBarStyle
...
--- - [`config.cursor_blink_rate`](lua://wezterm.Config.cursor_blink_rate)
...
--- - [`config.text_blink_rapid_ease_in`](lua://wezterm.Config.text_blink_rapid_ease_in)
--- - [`config.text_blink_rapid_ease_out`](lua://wezterm.Config.text_blink_rapid_ease_out)
---
...
---[`config.adjust_window_size_when_changing_font_size`](lua://wezterm.Config.adjust_window_size_when_changing_font_size)
---configuration field.
---
...
---
---@field tls_clients? wezterm.TlsDomainClient[]
---Configures TLS multiplexing domains.
---
---Read more about TLS Domains [here](https://wezterm.org/multiplexing.html#tls-domains).
---
...
---
---@field tls_servers? wezterm.TlsDomainServer[]
...
---
---@field unix_domains? wezterm.UnixDomain[]
...
---[`config.window_padding`](lua://wezterm.Config.window_padding)
...
---
---See also:
--- - [`config.audible_bell`](lua://wezterm.Config.audible_bell)
--- - [`Bell`](https://wezterm.org/config/lua/window-events/bell.html)
---
---@field visual_bell? wezterm.VisualBell
...
---[`config.front_end`](lua://wezterm.Config.front_end).
---
---A more fine grained control over which GPU is selected also relies on
---[`config.webgpu_preferred_adapter`](lua://wezterm.Config.webgpu_preferred_adapter).
---
...
---
---@field webgpu_preferred_adapter? wezterm.GpuInfo
---When combined with
---[`config.win32_system_backdrop`](lua://wezterm.Config.win32_system_backdrop)
...
---When combined with
---[`config.window_background_opacity`](lua://wezterm.Config.window_background_opacity)
...
---[`config.window_background_image`](lua://wezterm.Config.window_background_image)
...
---are supported.
---
---@field window_background_gradient? wezterm.Gradient
...
---
---@field window_decorations? wezterm.WindowDecorations
...
---
---@field wsl_domains? wezterm.WslDomain[]
